...
public class TbUserServiceImpl extends ServiceImpl<TbUserMapper, TbUser> implements TbUserService {
    ...
    private final static String key = "user:verify:phone:";
    @Override
...
//        验证code
        String cacheCode = redisTemplate.opsForValue().get(key + user.getPhone());
...
//        保存数据库
        ...
        //删除redis中的code值
//        redisTemplate.delete(key + user.getPhone());
    }
